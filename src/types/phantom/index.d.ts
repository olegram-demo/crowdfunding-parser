...
export function create(args?: string[], options?:any): Promise<PhantomJS>;
...
export interface WebPage {
    ...
    property<T>(key: string, value: T, passVar: any): Promise<void>;
    ...
    on<T>(key: string, value: T): Promise<void>;
}
